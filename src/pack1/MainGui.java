...
public class MainGui extends JFrame {
	...
	public MainGui() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) { // NOPMD by Chris on 31/1/2016 9:30 μμ
				HR frame1 = new HR();
		...
		JButton btnNewButton_1 = new JButton("Supervisor"); // NOPMD by Chris on 31/1/2016 9:29 μμ
